...
<html lang="en">
  ...
  <div class="container-fluid">
      <h2 class="text-center alert alert-success">Laravel CRUD Application</h2>
      <div class="row">
          <section class="col">
          @include("studentlist")
          </section>
  ...
  <div class="container-fluid">
      ...
      <div class="row">
          ...
          <section class="col">
          <h6 class="text-center alert alert-info">Add Student Information</h6>
...
@csrf
  ...
  <div class="container-fluid">
      ...
      <div class="row">
          ...
          <section class="col">
          <h6 class="text-center alert alert-info">Edit Student Information</h6>
